...
impl Record {
    ...
    pub fn from_vcf_allele(
        ...
        let alt_allele = record
            ...
            .to_string();
        let variant_collapsed = common::noodles_utils::get_string(record, "variant_collapsed")?;
        let excluded_ac = common::noodles_utils::get_i32(record, "excluded_AC")?;
        let an = common::noodles_utils::get_i32(record, "AN")?;
        let ac_hom = common::noodles_utils::get_i32(record, "AC_hom")?;
        let ac_het = common::noodles_utils::get_i32(record, "AC_het")?;
        let af_hom = common::noodles_utils::get_f32(record, "AF_hom")?;
        let af_het = common::noodles_utils::get_f32(record, "AF_het")?;
        let filters = Self::extract_filters(record)?;
        let mitotip_score = common::noodles_utils::get_f32(record, "mitotip_score").ok();
        let mitotip_trna_prediction =
            common::noodles_utils::get_string(record, "mitotip_trna_prediction").ok();
        let pon_mt_trna_prediction =
            common::noodles_utils::get_string(record, "pon_mt_trna_prediction").ok();
        let pon_ml_probability_of_pathogenicity =
            common::noodles_utils::get_string(record, "pon_ml_probability_of_pathogenicity").ok();
    ...
    fn extract_heteroplasmy(
        ...
        Ok(HeteroplasmyInfo {
            heteroplasmy_below_min_het_threshold_hist: common::noodles_utils::get_vec::<i32>(
                record,
                "heteroplasmy_below_min_het_threshold_hist",
            )?,
            hl_hist: common::noodles_utils::get_vec::<i32>(record, "hl_hist")?,
            common_low_heteroplasmy: common::noodles_utils::get_flag(
                record,
                "common_low_heteroplasmy",
            )?,
            max_hl: common::noodles_utils::get_f32(record, "max_hl")?,
        })
    }
    ...
    fn extract_filter_histograms(
        ...
        Ok(FilterHistograms {
            base_qual_hist: common::noodles_utils::get_vec::<i32>(record, "base_qual_hist")
                .unwrap_or_default(),
            position_hist: common::noodles_utils::get_vec::<i32>(record, "position_hist")
                .unwrap_or_default(),
            strand_bias_hist: common::noodles_utils::get_vec::<i32>(record, "strand_bias_hist")
                .unwrap_or_default(),
            weak_evidence_hist: common::noodles_utils::get_vec::<i32>(record, "weak_evidence_hist")
                .unwrap_or_default(),
            contamination_hist: common::noodles_utils::get_vec::<i32>(record, "contamination_hist")
                .unwrap_or_default(),
        })
    }
    ...
    fn extract_population(
        ...
        Ok(PopulationInfo {
            pop_an: common::noodles_utils::get_vec::<i32>(record, "pop_AN")?,
            pop_ac_het: common::noodles_utils::get_vec::<i32>(record, "pop_AC_het")
                .unwrap_or_default(),
            pop_ac_hom: common::noodles_utils::get_vec::<i32>(record, "pop_AC_hom")
                .unwrap_or_default(),
            pop_af_hom: common::noodles_utils::get_vec::<f32>(record, "pop_AF_hom")
                .unwrap_or_default(),
            pop_af_het: common::noodles_utils::get_vec::<f32>(record, "pop_AF_het")
                .unwrap_or_default(),
            pop_hl_hist: common::noodles_utils::get_vec_vec::<i32>(record, "pop_hl_hist")
                .unwrap_or_default(),
        })
    }
    ...
    fn extract_haplogroup(
        ...
        Ok(HaplogroupInfo {
            hap_defining_variant: common::noodles_utils::get_flag(record, "hap_defining_variant")?,
            hap_an: common::noodles_utils::get_vec::<i32>(record, "hap_AN").unwrap_or_default(),
            hap_ac_het: common::noodles_utils::get_vec::<i32>(record, "hap_AC_het")
                .unwrap_or_default(),
            hap_ac_hom: common::noodles_utils::get_vec::<i32>(record, "hap_AC_hom")
                .unwrap_or_default(),
            hap_af_het: common::noodles_utils::get_vec::<f32>(record, "hap_AF_het")
                .unwrap_or_default(),
            hap_af_hom: common::noodles_utils::get_vec::<f32>(record, "hap_AF_hom")
                .unwrap_or_default(),
            hap_hl_hist: common::noodles_utils::get_vec_vec::<i32>(record, "hap_hl_hist")
                .unwrap_or_default(),
            hap_faf_hom: common::noodles_utils::get_vec::<f32>(record, "hap_faf_hom")
                .unwrap_or_default(),
            hapmax_af_hom: common::noodles_utils::get_string(record, "hapmax_AF_hom").ok(),
            hapmax_af_het: common::noodles_utils::get_string(record, "hapmax_AF_het").ok(),
            faf_hapmax_hom: common::noodles_utils::get_f32(record, "faf_hapmax_hom").ok(),
        })
    }
    ...
    fn extract_quality(
        ...
        Ok(QualityInfo {
            dp_mean: common::noodles_utils::get_f32(record, "dp_mean").ok(),
            mq_mean: common::noodles_utils::get_f32(record, "mq_mean").ok(),
            tlod_mean: common::noodles_utils::get_f32(record, "tlod_mean").ok(),
        })
    }
