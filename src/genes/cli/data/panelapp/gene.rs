...
impl Gene {
  pub fn new(entity_type: String, entity_name: String, confidence_level: String, publications: Vec<String>, evidence: Vec<String>, phenotypes: Vec<String>, mode_of_inheritance: String, transcript: Vec<String>) -> Gene {
    Gene {
      gene_data: None,
  ...
  pub fn with_panel(mut self, panel: ::models::Panel) -> Gene {
    self.panel = Some(panel);
    self
  }
