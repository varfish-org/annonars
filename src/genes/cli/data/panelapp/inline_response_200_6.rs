...
pub struct InlineResponse2006 {
  ...
  results: Vec<::models::Region>
}

impl InlineResponse2006 {
  pub fn new(count: i32, results: Vec<::models::Region>) -> InlineResponse2006 {
    InlineResponse2006 {
      count: count,
      next: None,
      previous: None,
  ...
  pub fn set_results(&mut self, results: Vec<::models::Region>) {
    self.results = results;
  }

  pub fn with_results(mut self, results: Vec<::models::Region>) -> InlineResponse2006 {
    self.results = results;
    self
  }

  pub fn results(&self) -> &Vec<::models::Region> {
    &self.results
  }
