...
impl InlineResponse2006 {
  pub fn new(count: i32, results: Vec<crate::genes::cli::data::panelapp::Region>) -> InlineResponse2006 {
    InlineResponse2006 {
      count: count,
      next: None,
      previous: None,
  ...
  pub fn with_results(mut self, results: Vec<crate::genes::cli::data::panelapp::Region>) -> InlineResponse2006 {
    self.results = results;
    self
  }
