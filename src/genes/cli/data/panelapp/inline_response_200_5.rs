...
impl InlineResponse2005 {
  ...
  pub fn with_count(mut self, count: i32) -> InlineResponse2005 {
    self.count = count;
    self
  }
  ...
  pub fn with_next(mut self, next: String) -> InlineResponse2005 {
    self.next = Some(next);
    self
  }
  ...
  pub fn with_previous(mut self, previous: String) -> InlineResponse2005 {
    self.previous = Some(previous);
    self
  }
